...
public class TrackerService extends Service {
    ...
    String userKey="default",service;
    @Override
    ...
    protected BroadcastReceiver stopReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            databaseReference.child(getString(R.string.firebase_path)).child(getString(R.string.services)).child(service).child(userKey).setValue("false");
        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(
            ...
            public void onComplete(Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Log.d(TAG, "TA - firebase auth success");
                    requestLocationUpdates();
                } else {
                    Log.d(TAG, "TA - firebase auth failed");
                }
            }
        });
    }
    ...
    private void requestLocationUpdates() {
        ...
        final String path = getString(R.string.firebase_path) + "/" + getString(R.string.track) + "/" + service + "/" + userKey;
        int permission = ContextCompat.checkSelfPermission(this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        if (permission == PackageManager.PERMISSION_GRANTED) {
            // Request location updates and when an update is
            // received, store the location in Firebase
            Log.d("paapu","TrackerService - granted");
